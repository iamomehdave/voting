                ...
                <div class="card-body">
                    <form onsubmit="payWithPaystack()">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" id="phone" class="form-control @error('name') is-invalid @enderror" name="phone" value="{{ old('phone') }}" required autocomplete="phone" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control @error('contestant') is-invalid @enderror" name="contestant" id="contestant" required autocomplete="contestant">
      ...
      callback: function(response){
        ...
        alert('success. transaction ref is ' + response.reference);
         ...
         $.ajax({
              ...
              window.location.href = "http://paragontalent.test" ;
