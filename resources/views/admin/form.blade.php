                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="fname" type="text" class="form-control @error('fname') is-invalid @enderror" name="fname" value="{{ old('fname') ?? $value->fname }}" required autocomplete="fname" autofocus>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="lname" type="text" class="form-control @error('lname') is-invalid @enderror" name="lname" value="{{ old('lname') ?? $value->lname }}" required autocomplete="lname">
         	...
         	<div class="form-group row">
               <label for="image" class="col-md-4 col-form-label text-md-right">{{ __('Contestant Image') }}</label>
            	<div class="col-md-6">
                    <input type="file"  id="customFile" name="image"value="{{ old('image')?? $value->image }}">
  				</div>
            </div>
            @csrf
